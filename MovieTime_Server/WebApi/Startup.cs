...
namespace WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddScoped<IMovieTimeDbContext, MovieTimeDbContext>();
            ...
            services.AddIdentity<IdentityUser, IdentityRole>(options => options.SignIn.RequireConfirmedAccount = true)
             .AddEntityFrameworkStores<MovieTimeDbContext>();
            services.AddDbContext<MovieTimeDbContext>(item => item.UseSqlServer(Configuration.GetConnectionString("DbConnection")));
    }
